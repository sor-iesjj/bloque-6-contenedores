...
> ### 📌 `B6.5.3` — Comparativa con Samba y NFS de UD07
> - **Bloque 6** (Aislamiento de servicios) · **Fase B6.5** (Integración libre ↔ propietario) · **Nivel 2** (Intermedio) · **RA6** · **CE 6.a, 6.c**
> - **🎬 Playlist:** `B6_Contenedores`
...
> 4. **Al terminar:** nombra el vídeo **`B6.5.3 · Comparativa con Samba y NFS`** y súbelo a **`B6_Contenedores`** (No listado).
> 5. **Una sola entrega.**
...
>
> **Una persona edita por Samba desde Windows; un contenedor Linux lo publica.** Esta es la arquitectura real de muchas empresas y el mejor resumen del RA6. **Grábalo.**
...
- **Entregable vídeo:** `B6.5.3 · Comparativa con Samba y NFS` en `B6_Contenedores`. **Una sola entrega.**
...
>
> **Siguiente:** [[B6_6.1_Docker_Stats_vs_Htop|B6.6.1 — `docker stats` frente a `htop`]] · **RA5**.
