...
> ### 📌 `B6.5.1` — Docker Desktop sobre Windows con WSL2
> - **Bloque 6** (Aislamiento de servicios) · **Fase B6.5** (Integración libre ↔ propietario) · **Nivel 2** (Intermedio) · **RA6** · **CE 6.a, 6.b**
> - **🎬 Playlist:** `B6_Contenedores`
...
> En la empresa los servidores son Linux pero los puestos de trabajo son Windows. Los técnicos necesitan probar en su propio equipo los mismos contenedores que luego irán al servidor, sin montarse una máquina virtual para cada prueba. **Es el escenario heterogéneo típico** y el que evalúa el RA6.
...
> 4. **Al terminar:** nombra el vídeo **`B6.5.1 · Docker Desktop sobre Windows con WSL2`** y súbelo a **`B6_Contenedores`** (No listado).
> 5. **Una sola entrega.**
...
> | Creer que Docker corre "nativo" en Windows | No se entiende el RA6 | Por debajo **hay una VM Linux**. |
...
> 5. ¿Por qué esta práctica evalúa el RA6 (integración de sistemas libres y propietarios)?
...
- **Entregable vídeo:** `B6.5.1 · Docker Desktop sobre Windows con WSL2` en `B6_Contenedores`. **Una sola entrega.**
