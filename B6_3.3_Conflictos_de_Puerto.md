...
> ### 📌 `B6.3.3` — Varios contenedores a la vez y conflictos de puerto
> - **Bloque 6** (Aislamiento de servicios) · **Fase B6.3** (Red y puertos) · **Nivel 2** (Intermedio) · **RA1** · **CE 1.e, 1.i**
> - **🎬 Playlist:** `B6_Contenedores`
...
> 4. **Al terminar:** nombra el vídeo **`B6.3.3 · Varios contenedores y conflictos de puerto`** y súbelo a **`B6_Contenedores`** (No listado).
> 5. **Una sola entrega.**
...
- **Entregable vídeo:** `B6.3.3 · Varios contenedores y conflictos de puerto` en `B6_Contenedores`. **Una sola entrega.**
